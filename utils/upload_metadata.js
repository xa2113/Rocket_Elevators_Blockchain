...
fs.writeFileSync(`${basePath}/nft/_ipfsMetas.json`, "");
const writer = fs.createWriteStream(`${basePath}/nft/_ipfsMetas.json`, {
    flags: "a",
});
writer.write("[");
const jsonFile = fs.readFileSync(`${basePath}/nft/json/1.json`);
